 ...
 */
public class JobExtracaoSysBMapper extends Mapper<Object, Text, NullWritable, Text> {
	...
	public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
		...
		if (m.matches()) { 
			...
			Text registro = JobExtracaoSysBUtil.retornaRegistro(value);
			if (!"00".equals(JobExtracaoSysBUtil.getResposta())) { // Verifica se realmente é erro
